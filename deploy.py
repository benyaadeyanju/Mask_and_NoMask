...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    #model = torch.hub.download_url_to_file('https://ultralytics.com/images/')
    #model =  torch.hub.load('C:\Users\Asus99\Desktop\yolov5_deploy-main\yolov5_deploy', 'custom', source ='local', path='last.pt',force_reload=True)
...
#main(vid_path="mmu.mp4",vid_out="facemask_result.mp4") ### for custom video
main(vid_path="mmu-1.mp4",vid_out="facemask_result.mp4") ### for custom video
